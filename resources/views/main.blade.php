                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <div class="d-flex flex-row">
                                <a href="https://vk.com/{{ $post['vk'] }}" class="mr-2 fs-xxl" style="color:#4680C2">
                                    <i class="fab fa-vk"></i>
                                </a>
                                <a href="https://tg.com/{{ $post['tg'] }}" class="mr-2 fs-xxl" style="color:#38A1F3">
                                    <i class="fab fa-telegram"></i>
                                </a>
                                <a href="https://insta/{{ $post['inst'] }}" class="mr-2 fs-xxl" style="color:#E1306C">
