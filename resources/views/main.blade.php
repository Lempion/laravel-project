    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <div class="row" id="js-contacts">
            ...
            @foreach($posts as $num => $post)
                <div class="col-xl-4">
                    <div id="c_{{ $num }}" class="card border shadow-0 mb-g shadow-sm-hover"
                         data-filter-tags="{{ $post['name'] }}">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <button class="js-expand-btn btn btn-sm btn-default d-none" data-toggle="collapse"
                                        data-target="#c_{{ $num }} > .card-body + .card-body" aria-expanded="false">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="{{ $post['phone'] }}" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> {{ $post['phone'] }}</a>
                                <a href="mailto:{{ $post['email'] }}"
                                   class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> {{ $post['email'] }}</a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> {{ $post['address'] }}
                                </address>
                                <div class="d-flex flex-row">
                                    <a href="https://vk.com/{{ $post['vk'] }}" class="mr-2 fs-xxl"
                                       style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="https://tg.com/{{ $post['tg'] }}" class="mr-2 fs-xxl"
                                       style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="https://insta/{{ $post['inst'] }}" class="mr-2 fs-xxl"
                                       style="color:#E1306C">
